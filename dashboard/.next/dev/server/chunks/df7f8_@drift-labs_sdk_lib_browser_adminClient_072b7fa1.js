module.exports = [
"[project]/dashboard/node_modules/.pnpm/@drift-labs+sdk@2.149.0-beta.0_@solana+sysvars@2.3.0_fastestsmallesttextencoderdecoder@1.0.22_typescript@5.9.3_ws@8.18.3/node_modules/@drift-labs/sdk/lib/browser/adminClient.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const driftClient_1 = __turbopack_context__.r("[project]/dashboard/node_modules/.pnpm/@drift-labs+sdk@2.149.0-beta.0_@solana+sysvars@2.3.0_fastestsmallesttextencoderdecoder@1.0.22_typescript@5.9.3_ws@8.18.3/node_modules/@drift-labs/sdk/lib/browser/driftClient.js [app-route] (ecmascript)");
...
class AdminClient extends driftClient_1.DriftClient {
    ...
    async getInitializeAmmCacheIx() {
        return await this.program.instruction.initializeAmmCache({
            accounts: {
                state: await this.getStatePublicKey(),
                admin: this.useHotWalletAdmin ? this.wallet.publicKey : this.getStateAccount().admin,
                rent: web3_js_1.SYSVAR_RENT_PUBKEY,
    ...
    async getInitializeProtectedMakerModeConfigIx(maxUsers, stateAdmin) {
        return await this.program.instruction.initializeProtectedMakerModeConfig(maxUsers, {
            accounts: {
                admin: stateAdmin ? this.getStateAccount().admin : this.wallet.publicKey,
                state: await this.getStatePublicKey(),
                rent: web3_js_1.SYSVAR_RENT_PUBKEY,
                systemProgram: anchor.web3.SystemProgram.programId,
    ...
    async getInitializeLpPoolIx(lpPoolId, minMintFee, maxAum, maxSettleQuoteAmountPerMarket, mint, whitelistMint) {
        ...
        const createMintAccountIx = web3_js_1.SystemProgram.createAccount({
            ...
            lamports: Math.min(0.05 * web3_js_1.LAMPORTS_PER_SOL, lamports),
...
//# sourceMappingURL=df7f8_%40drift-labs_sdk_lib_browser_adminClient_072b7fa1.js.map