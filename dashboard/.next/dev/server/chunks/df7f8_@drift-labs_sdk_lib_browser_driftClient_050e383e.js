module.exports = [
"[project]/dashboard/node_modules/.pnpm/@drift-labs+sdk@2.149.0-beta.0_@solana+sysvars@2.3.0_fastestsmallesttextencoderdecoder@1.0.22_typescript@5.9.3_ws@8.18.3/node_modules/@drift-labs/sdk/lib/browser/driftClient.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const types_2 = __turbopack_context__.r("[project]/dashboard/node_modules/.pnpm/@drift-labs+sdk@2.149.0-beta.0_@solana+sysvars@2.3.0_fastestsmallesttextencoderdecoder@1.0.22_typescript@5.9.3_ws@8.18.3/node_modules/@drift-labs/sdk/lib/browser/accounts/types.js [app-route] (ecmascript)");
...
const pollingDriftClientAccountSubscriber_1 = __turbopack_context__.r("[project]/dashboard/node_modules/.pnpm/@drift-labs+sdk@2.149.0-beta.0_@solana+sysvars@2.3.0_fastestsmallesttextencoderdecoder@1.0.22_typescript@5.9.3_ws@8.18.3/node_modules/@drift-labs/sdk/lib/browser/accounts/pollingDriftClientAccountSubscriber.js [app-route] (ecmascript)");
...
const retryTxSender_1 = __turbopack_context__.r("[project]/dashboard/node_modules/.pnpm/@drift-labs+sdk@2.149.0-beta.0_@solana+sysvars@2.3.0_fastestsmallesttextencoderdecoder@1.0.22_typescript@5.9.3_ws@8.18.3/node_modules/@drift-labs/sdk/lib/browser/tx/retryTxSender.js [app-route] (ecmascript)");
...
const fetch_1 = __turbopack_context__.r("[project]/dashboard/node_modules/.pnpm/@drift-labs+sdk@2.149.0-beta.0_@solana+sysvars@2.3.0_fastestsmallesttextencoderdecoder@1.0.22_typescript@5.9.3_ws@8.18.3/node_modules/@drift-labs/sdk/lib/browser/accounts/fetch.js [app-route] (ecmascript)");
...
const orderParams_1 = __turbopack_context__.r("[project]/dashboard/node_modules/.pnpm/@drift-labs+sdk@2.149.0-beta.0_@solana+sysvars@2.3.0_fastestsmallesttextencoderdecoder@1.0.22_typescript@5.9.3_ws@8.18.3/node_modules/@drift-labs/sdk/lib/browser/orderParams.js [app-route] (ecmascript)");
...
const pythOracleUtils_1 = __turbopack_context__.r("[project]/dashboard/node_modules/.pnpm/@drift-labs+sdk@2.149.0-beta.0_@solana+sysvars@2.3.0_fastestsmallesttextencoderdecoder@1.0.22_typescript@5.9.3_ws@8.18.3/node_modules/@drift-labs/sdk/lib/browser/util/pythOracleUtils.js [app-route] (ecmascript)");
const ed25519Utils_1 = __turbopack_context__.r("[project]/dashboard/node_modules/.pnpm/@drift-labs+sdk@2.149.0-beta.0_@solana+sysvars@2.3.0_fastestsmallesttextencoderdecoder@1.0.22_typescript@5.9.3_ws@8.18.3/node_modules/@drift-labs/sdk/lib/browser/util/ed25519Utils.js [app-route] (ecmascript)");
const utils_2 = __turbopack_context__.r("[project]/dashboard/node_modules/.pnpm/@drift-labs+sdk@2.149.0-beta.0_@solana+sysvars@2.3.0_fastestsmallesttextencoderdecoder@1.0.22_typescript@5.9.3_ws@8.18.3/node_modules/@drift-labs/sdk/lib/browser/tx/utils.js [app-route] (ecmascript)");
const pyth_solana_receiver_json_1 = __importDefault(__turbopack_context__.r("[project]/dashboard/node_modules/.pnpm/@drift-labs+sdk@2.149.0-beta.0_@solana+sysvars@2.3.0_fastestsmallesttextencoderdecoder@1.0.22_typescript@5.9.3_ws@8.18.3/node_modules/@drift-labs/sdk/lib/browser/idl/pyth_solana_receiver.json (json)"));
...
const grpcDriftClientAccountSubscriber_1 = __turbopack_context__.r("[project]/dashboard/node_modules/.pnpm/@drift-labs+sdk@2.149.0-beta.0_@solana+sysvars@2.3.0_fastestsmallesttextencoderdecoder@1.0.22_typescript@5.9.3_ws@8.18.3/node_modules/@drift-labs/sdk/lib/browser/accounts/grpcDriftClientAccountSubscriber.js [app-route] (ecmascript)");
...
const utils_3 = __turbopack_context__.r("[project]/dashboard/node_modules/.pnpm/@drift-labs+sdk@2.149.0-beta.0_@solana+sysvars@2.3.0_fastestsmallesttextencoderdecoder@1.0.22_typescript@5.9.3_ws@8.18.3/node_modules/@drift-labs/sdk/lib/browser/oracles/utils.js [app-route] (ecmascript)");
...
const builder_1 = __turbopack_context__.r("[project]/dashboard/node_modules/.pnpm/@drift-labs+sdk@2.149.0-beta.0_@solana+sysvars@2.3.0_fastestsmallesttextencoderdecoder@1.0.22_typescript@5.9.3_ws@8.18.3/node_modules/@drift-labs/sdk/lib/browser/math/builder.js [app-route] (ecmascript)");
...
const UnifiedSwapClient_1 = __turbopack_context__.r("[project]/dashboard/node_modules/.pnpm/@drift-labs+sdk@2.149.0-beta.0_@solana+sysvars@2.3.0_fastestsmallesttextencoderdecoder@1.0.22_typescript@5.9.3_ws@8.18.3/node_modules/@drift-labs/sdk/lib/browser/swap/UnifiedSwapClient.js [app-route] (ecmascript)");
/**
 * # DriftClient
 ...
 */ class DriftClient {
    ...
    constructor(config){
        ...
        this.provider = new anchor_1.AnchorProvider(config.connection, // @ts-ignore
        ...
        this.txVersion = (_h = config.txVersion) !== null && _h !== void 0 ? _h : this.getTxVersionForNewWallet(config.wallet);
        this.txParams = {
        ...
        this.txHandler = (_o = config === null || config === void 0 ? void 0 : config.txHandler) !== null && _o !== void 0 ? _o : new txHandler_1.TxHandler({
        ...
        this.txSender = (_26 = config.txSender) !== null && _26 !== void 0 ? _26 : new retryTxSender_1.RetryTxSender({
            connection: this.connection,
            wallet: this.wallet,
            opts: this.opts,
    ...
    /** @deprecated use fetchAllLookupTableAccounts() */ async fetchMarketLookupTableAccount() {
    ...
    getTxVersionForNewWallet(newWallet) {
        var _a, _b, _c;
        if (!(newWallet === null || newWallet === void 0 ? void 0 : newWallet.supportedTransactionVersions)) return 0; // Assume versioned txs supported if wallet doesn't have a supportedTransactionVersions property
        const walletSupportsVersionedTxns = ((_a = newWallet.supportedTransactionVersions) === null || _a === void 0 ? void 0 : _a.has(0)) || ((_c = (_b = newWallet.supportedTransactionVersions) === null || _b === void 0 ? void 0 : _b.size) !== null && _c !== void 0 ? _c : 0) > 1;
     ...
     */ async updateWallet(newWallet, subAccountIds, activeSubAccountId, includeDelegates, authoritySubaccountMap) {
        var _a;
        const newProvider = new anchor_1.AnchorProvider(this.connection, // @ts-ignore
        newWallet, this.opts);
        ...
        /* Reset user stats account */ if ((_a = this.userStats) === null || _a === void 0 ? void 0 : _a.isSubscribed) {
    ...
    async switchActiveUser(subAccountId, authority) {
        ...
        /* If changing the user authority ie switching from delegate to non-delegate account, need to re-subscribe to the user stats account */ if (authorityChanged && this.userStats) {
    ...
    getRemainingAccounts(params) {
        ...
        if (params.useMarketLastSlotCache) {
            const lastUserSlot = (_a = this.getUserAccountAndSlot(params.userAccounts.length > 0 ? params.userAccounts[0].subAccountId : this.activeSubAccountId, params.userAccounts.length > 0 ? params.userAccounts[0].authority : this.authority)) === null || _a === void 0 ? void 0 : _a.slot;
    ...
    async getDepositInstruction(amount, marketIndex, userTokenAccount, subAccountId, reduceOnly = false, userInitialized = true) {
        ...
        if (userInitialized) {
            remainingAccounts = this.getRemainingAccounts({
                userAccounts: [
                    await this.forceGetUserAccount(subAccountId)
                ],
    ...
    async createInitializeUserAccountAndDepositCollateralIxs(amount, userTokenAccount, marketIndex = 0, subAccountId = 0, name, fromSubAccountId, referrerInfo, donateAmount, customMaxMarginRatio, poolId) {
        ...
        const createWSOLTokenAccount = isSolMarket && userTokenAccount.equals(authority) && !isFromSubaccount || !donateAmount.eq(numericConstants_1.ZERO);
    ...
    async withdrawAllDustPositions(subAccountId, txParams, opts) {
        ...
        for (const position of dustPositionSpotMarketAccounts){
            ...
            const withdrawIxs = await this.getWithdrawalIxs(tokenAmount.muln(2), position.marketIndex, tokenAccount, true, subAccountId);
    ...
    async prepareMarketOrderTxs(orderParams, userAccountPublicKey, userAccount, makerInfo, txParams, bracketOrdersParams = new Array(), referrerInfo, cancelExistingOrders, settlePnl, positionMaxLev) {
        ...
        const marketOrderTxIxs = positionMaxLev ? this.getPlaceOrdersAndSetPositionMaxLevIx([
            orderParams,
            ...bracketOrdersParams
        ], positionMaxLev, userAccount.subAccountId) : this.getPlaceOrdersIx([
            orderParams,
            ...bracketOrdersParams
        ], userAccount.subAccountId);
        ixPromisesForTxs.marketOrderTx = marketOrderTxIxs;
        /* Cancel open orders in market if requested */ if (cancelExistingOrders && (0, types_1.isVariant)(orderParams.marketType, 'perp')) {
        ...
        /* Settle PnL after fill if requested */ if (settlePnl && (0, types_1.isVariant)(orderParams.marketType, 'perp')) {
    ...
    async getPlacePerpOrderIx(orderParams, subAccountId, depositToTradeArgs) {
        ...
        const user = isDepositToTradeTx ? (0, pda_1.getUserAccountPublicKeySync)(this.program.programId, this.authority, subAccountId) : await this.getUserAccountPublicKey(subAccountId);
        const remainingAccounts = this.getRemainingAccounts({
    ...
    async getSettleExpiredMarketIx(marketIndex) {
        ...
        return await this.program.instruction.settleExpiredMarket(marketIndex, {
            accounts: {
                state: await this.getStatePublicKey(),
                admin: this.isSubscribed ? this.getStateAccount().admin : this.wallet.publicKey,
    ...
    async placeSpotOrder(orderParams, txParams, subAccountId) {
        const { txSig, slot } = await this.sendTransaction((await this.preparePlaceSpotOrderTx(orderParams, txParams, subAccountId)).placeSpotOrderTx, [], this.opts, false);
    ...
    async getTitanSwapIx({ titanClient, outMarketIndex, inMarketIndex, outAssociatedTokenAccount, inAssociatedTokenAccount, amount, slippageBps, swapMode, onlyDirectRoutes, reduceOnly, userAccountPublicKey }) {
        ...
        const { transactionMessage, lookupTables } = await titanClient.getSwap({
            ...
            onlyDirectRoutes,
            sizeConstraint: utils_2.MAX_TX_BYTE_SIZE - 375
        });
        ...
        const prepCancelOrderTx = async ()=>{
            if (cancelExistingOrders && (0, types_1.isVariant)(orderParams.marketType, 'perp')) {
                ...
                txsToSign.cancelExistingOrdersTx = await this.buildTransaction([
                    cancelOrdersIx
                ], txParams, this.txVersion, lookupTableAccounts, undefined, recentBlockHash, optionalIxs);
            }
            return;
        };
    ...
    async placeAndTakePerpWithAdditionalOrders(orderParams, makerInfo, referrerInfo, bracketOrdersParams = new Array(), txParams, subAccountId, cancelExistingOrders, settlePnl, exitEarlyIfSimFails) {
        ...
        const signedTxs = (await this.txHandler.getSignedTransactionMap(txsToSign, // @ts-ignore
    ...
    async getPlaceAndTakePerpOrderIx(orderParams, makerInfo, referrerInfo, successCondition, auctionDurationPercentage, subAccountId, overrides) {
        ...
        if (auctionDurationPercentage || successCondition) {
            optionalParams = (auctionDurationPercentage !== null && auctionDurationPercentage !== void 0 ? auctionDurationPercentage : 100) << 8 | (successCondition !== null && successCondition !== void 0 ? successCondition : 0);
        }
        const authority = (_a = overrides === null || overrides === void 0 ? void 0 : overrides.authority) !== null && _a !== void 0 ? _a : this.wallet.publicKey;
     ...
     */ encodeSignedMsgOrderParamsMessage(orderParamsMessage, delegateSigner) {
        ...
        const anchorIxName = delegateSigner ? 'global' + ':' + 'SignedMsgOrderParamsDelegateMessage' : 'global' + ':' + 'SignedMsgOrderParamsMessage';
        ...
        const withBuilderDefaults = {
            ...orderParamsMessage,
            builderIdx: orderParamsMessage.builderIdx !== undefined ? orderParamsMessage.builderIdx : null,
            builderFeeTenthBps: orderParamsMessage.builderFeeTenthBps !== undefined ? orderParamsMessage.builderFeeTenthBps : null
        };
        const buf = Buffer.concat([
            prefix,
            delegateSigner ? this.program.coder.types.encode('SignedMsgOrderParamsDelegateMessage', withBuilderDefaults) : this.program.coder.types.encode('SignedMsgOrderParamsMessage', withBuilderDefaults)
        ]);
        return buf;
    }
    /*
    ...
    async getPlaceSignedMsgTakerPerpOrderIxs(signedSignedMsgOrderParams, marketIndex, takerInfo, precedingIxs = [], overrideCustomIxIndex) {
        ...
        if (signedMessage.builderFeeTenthBps !== null && signedMessage.builderIdx !== null) {
            remainingAccounts.push({
                pubkey: (0, pda_1.getRevenueShareEscrowAccountPublicKey)(this.program.programId, takerInfo.takerUserAccount.authority),
                isWritable: true,
                isSigner: false
        ...
        return [
            signedMsgOrderParamsSignatureIx,
    ...
    async settlePNLs(users, marketIndexes, opts, txParams) {
        ...
        const marketIndexToSettle = filterInvalidMarkets ? [] : marketIndexes;
        ...
        if (revenueShareEscrowMap) {
            ...
            if (escrow) {
                ...
                for (const order of escrow.orders){
                    const eligibleBuilder = (0, builder_1.isBuilderOrderCompleted)(order) && !(0, builder_1.isBuilderOrderReferral)(order) && order.feesAccrued.gt(numericConstants_1.ZERO) && order.marketIndex === marketIndex;
                ...
                const hasReferralForMarket = escrow.orders.some((o)=>(0, builder_1.isBuilderOrderReferral)(o) && o.feesAccrued.gt(numericConstants_1.ZERO) && o.marketIndex === marketIndex);
    ...
    async settleMultiplePNLsIx(settleeUserAccountPublicKey, settleeUserAccount, marketIndexes, mode, overrides, revenueShareEscrowMap) {
        ...
        if (revenueShareEscrowMap) {
            ...
            if (escrow) {
                for (const order of escrow.orders){
                    const eligibleBuilder = (0, builder_1.isBuilderOrderCompleted)(order) && !(0, builder_1.isBuilderOrderReferral)(order) && order.feesAccrued.gt(numericConstants_1.ZERO) && marketIndexes.includes(order.marketIndex);
                    if (eligibleBuilder && !builders.has(order.builderIdx)) {
                        builders.set(order.builderIdx, escrow.approvedBuilders[order.builderIdx].authority);
                    }
                }
                ...
                const hasReferralForRequestedMarkets = escrow.orders.some((o)=>(0, builder_1.isBuilderOrderReferral)(o) && o.feesAccrued.gt(numericConstants_1.ZERO) && marketIndexes.includes(o.marketIndex));
    ...
    async getLiquidatePerpIx(userAccountPublicKey, userAccount, marketIndex, maxBaseAssetAmount, limitPrice, liquidatorSubAccountId) {
        ...
        const remainingAccounts = this.getRemainingAccounts({
            userAccounts: [
                this.getUserAccount(liquidatorSubAccountId),
                userAccount
            ],
            useMarketLastSlotCache: true,
            writablePerpMarketIndexes: [
     ...
     */ async getLiquidateSpotWithSwapIx({ liabilityMarketIndex, assetMarketIndex, swapAmount: swapAmount, assetTokenAccount, liabilityTokenAccount, userAccount, userAccountPublicKey, userStatsAccountPublicKey, liquidatorSubAccountId }) {
        ...
        if (this.isToken2022(liabilitySpotMarket) || this.isToken2022(assetSpotMarket)) {
            remainingAccounts.push({
    ...
    getMMOracleDataForPerpMarket(marketIndex) {
        ...
        const pctDiff = perpMarket.amm.mmOraclePrice.sub(oracleData.price).abs().mul(numericConstants_1.PERCENTAGE_PRECISION).div(anchor_1.BN.max(oracleData.price, numericConstants_1.ONE));
        ...
        const doSlotCheckForRecency = oracleData.sequenceId == null || oracleData.sequenceId.eq(numericConstants_1.ZERO) || mmOracleSequenceId.eq(numericConstants_1.ZERO) || oracleData.sequenceId.sub(perpMarket.amm.mmOracleSequenceId).abs().gt(oracleData.sequenceId.div(new anchor_1.BN(10000)));
        let isExchangeOracleMoreRecent = true;
        if (doSlotCheckForRecency && oracleData.slot <= perpMarket.amm.mmOracleSlot) {
            isExchangeOracleMoreRecent = false;
        } else if (!doSlotCheckForRecency && oracleData.sequenceId < mmOracleSequenceId) {
            isExchangeOracleMoreRecent = false;
        }
        ...
        }, stateAccountAndSlot.data.oracleGuardRails) || perpMarket.amm.mmOraclePrice.eq(numericConstants_1.ZERO) || isExchangeOracleMoreRecent || pctDiff.gt(numericConstants_1.PERCENTAGE_PRECISION.divn(100)) // 1% threshold
        ) {
            return {
                ...oracleData,
                isMMOracleActive
     ...
     */ getMarketFees(marketType, marketIndex, user, enteringHighLeverageMode) {
        var _a;
        let feeTier;
        const userHLM = ((_a = user === null || user === void 0 ? void 0 : user.isHighLeverageMode('Initial')) !== null && _a !== void 0 ? _a : false) || enteringHighLeverageMode;
        if (user && !userHLM) {
            feeTier = user.getUserFeeTier(marketType);
        } else {
            const state = this.getStateAccount();
            feeTier = (0, types_1.isVariant)(marketType, 'perp') ? state.perpFeeStructure.feeTiers[0] : state.spotFeeStructure.feeTiers[0];
        }
    ...
    async getPostPythPullOracleUpdateAtomicIxs(vaaString, feedIds, numSignatures = 2) {
        ...
        if (accumulatorUpdateData.updates.length > 1) {
            ...
            const feedIdsToUse = typeof feedIds === 'string' ? [
                feedIds
            ] : feedIds;
    ...
    async getPostManySwitchboardOnDemandUpdatesAtomicIxs(feeds, recentSlothash, numSignatures = 3) {
        ...
        const [pullIxs, _luts, _rawResponse] = await on_demand_1.PullFeed.fetchUpdateManyLightIx(program, {
            ...
            recentSlothashes: recentSlothash ? [
                [
                    new anchor_1.BN(recentSlothash.slot),
                    recentSlothash.hash
                ]
            ] : undefined,
            chain: 'solana',
    ...
    async getBuildEncodedVaaIxs(vaa, guardianSet) {
        ...
        postIxs.push(await this.wormholeProgram.methods.initEncodedVaa().accounts({
            encodedVaa: encodedVaaKeypair.publicKey
        }).instruction());
        // Split the write into two ixs
        postIxs.push(await this.wormholeProgram.methods.writeEncodedVaa({
            index: 0,
        ...
        // Verify
        postIxs.push(await this.wormholeProgram.methods.verifyEncodedVaaV1().accounts({
            guardianSet,
            draftVaa: encodedVaaKeypair.publicKey
        }).instruction());
        return [
    ...
    async getAllLpPoolRemoveLiquidityIxs({ outMarketIndex, lpToBurn, minAmountOut, lpPool }, constituentMap, includeUpdateConstituentOracleInfo = true, view = false) {
        const ixs = [];
        ixs.push(...await this.getAllSettlePerpToLpPoolIxs(lpPool.lpPoolId, this.getPerpMarketAccounts().filter((marketAccount)=>marketAccount.lpStatus > 0).map((marketAccount)=>marketAccount.marketIndex)));
        ixs.push(...await this.getAllUpdateLpPoolAumIxs(lpPool, constituentMap, includeUpdateConstituentOracleInfo));
        if (view) {
...
//# sourceMappingURL=df7f8_%40drift-labs_sdk_lib_browser_driftClient_050e383e.js.map